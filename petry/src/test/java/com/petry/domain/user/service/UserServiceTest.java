...
class UserServiceTest {
    ...
    public void 회원가입_성공() throws Exception {
        ...
        User user = userRepository.findByuAccount(userSignUpDto.account()).orElseThrow(() -> new Exception("존재하지 않는 회원입니다."));
    ...
    public void 회원가입_실패_중복아이디() throws Exception {
        ...
        assertThat(assertThrows(Exception.class, () -> userService.signUp(userSignUpDto)).getMessage()).isEqualTo("이미 존재하는 아이디입니다.");
    }
    ...
    public void 회원탈퇴_실패_비밀번호불일치() throws Exception {
        ...
        assertThat(assertThrows(Exception.class, () -> userService.withdraw(PASSWORD+"1")).getMessage()).isEqualTo("비밀번호가 일치하지 않습니다.");
    }
